...
export default function Nav() {
    ...
    return (
        <nav className={`dark:text-white md:pl-3 md:pt-4 flex md:flex-col md:h-full text-lg gap-3 fixed z-10 bg-gray-100 dark:bg-gray-700
        md:bg-white md:dark:bg-gray-900 rounded-t-3xl md:rounded-t-none border-t md:border-t-0 border-gray-200 dark:border-gray-800
        inset-0 md:inset-auto top-auto w-full md:w-[4.25rem] ${isMenuOpen ? 'lg:w-52' : 'lg:w-[3.375rem]'}`}>
            <div className={`flex md:flex-col gap-3 w-full justify-around px-1.5 md:px-0`}>
                <Link href={'/'}
                    ...
                    md:pt-2 lg:pt-0 lg:px-2 lg:gap-3 md:hover:bg-gray-100 md:dark:hover:bg-gray-700 rounded-md
                    ${router.asPath === '/' ? 'md:bg-gray-100 md:dark:bg-gray-700 text-teal-500 dark:text-teal-400' : ''}`}>
                ...
                <Link href={'/seasonal'}
                    ...
                    className={`flex flex-col lg:flex-row items-center justify-center lg:justify-start w-14 lg:w-full h-16 lg:h-8
                    md:pt-2 lg:pt-0 lg:px-2 lg:gap-3 md:hover:bg-gray-100 md:dark:hover:bg-gray-700 rounded-md
                    ${router.asPath === '/seasonal' ? 'md:bg-gray-100 md:dark:bg-gray-700 text-teal-500 dark:text-teal-400' : ''}`}>
                ...
                <Link href={'/watch_list'}
                    ...
                    className={`flex flex-col lg:flex-row items-center justify-center lg:justify-start w-14 lg:w-full h-16 lg:h-8
                    md:pt-2 lg:pt-0 lg:px-2 lg:gap-3 md:hover:bg-gray-100 md:dark:hover:bg-gray-700 rounded-md
                    ${router.asPath === '/watch_list' ? 'md:bg-gray-100 md:dark:bg-gray-700 text-teal-500 dark:text-teal-400' : ''}`}>
                ...
                <Link href={'/finished'}
                    ...
                    className={`flex flex-col lg:flex-row items-center justify-center lg:justify-start w-14 lg:w-full h-16 lg:h-8
                    md:pt-2 lg:pt-0 lg:px-2 lg:gap-3 md:hover:bg-gray-100 md:dark:hover:bg-gray-700 rounded-md
                    ${router.asPath === '/finished' ? 'md:bg-gray-100 md:dark:bg-gray-700 text-teal-500 dark:text-teal-400' : ''}`}>
                ...
                <Link href={'/dropped'}
                    ...
                    className={`flex flex-col lg:flex-row items-center justify-center lg:justify-start w-14 lg:w-full h-16 lg:h-8
                    md:pt-2 lg:pt-0 lg:px-2 lg:gap-3 md:hover:bg-gray-100 md:dark:hover:bg-gray-700 rounded-md
                    ${router.asPath === '/dropped' ? 'md:bg-gray-100 md:dark:bg-gray-700 text-teal-500 dark:text-teal-400' : ''}`}>
